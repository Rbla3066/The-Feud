...
var sing = ["Sing for Them", 2, false, "sing", "sleep", "lullaby", "tuck"];
...
var tell = ["Tell them Off", 9, false, "yell", "tell", "off", "scream", "fuck", "say"];
...
var pens = ["Pens/Pencils", 50, false, "pen", "pens", "pencil", "pencils", "writing", "utensils"];
var paper = ["Paper", 20, false, "paper", "parchment", "sheet", "papers"];
var stapler = ["Stapler", 6, false, "stapler", "staplers"];
var clips = ["Paper Clips", 6, false, "clip", "clips", "pin"];
var comp2 = ["Computer", 4, false, "computer", "tablet"];
var tape = ["Tape", 4, false, "tape", "scotch", "duct"];
var post = ["Post-its", 3, false, "post", "sticky", "notes", "post-it", "post-its"];
var tp = ["Toilet Paper", 3, false, "tp", "toilet"];
var game6 = ["Name something people often steal from the office to use at home.", pens, paper, stapler, clips, comp2, tape, post, tp];
var shoes3 = ["Shoes/Clothes", 17, false, "shoes", "clothes", "pants", "shirt", "heels"];
var jewl = ["Jewelry/Watch", 13, false, "jewelry", "watch", "necklace", "wristlet", "bracelet", "gem", "ring"];
var house3 = ["House", 10, false, "house", "place", "apartment", "condo", "room"];
var car3 = ["Car", 9, false, "car", "vehicle", "automobile", "wheels"];
var pet3 = ["Pet", 8, false, "pet", "dog", "cat", "bird", "turtle", "hampster"];
var friends2 = ["Friendships", 8, false, "friend", "friends", "friendship", "friendships"];
var child3 = ["Children", 5, false, "child", "children", "son", "daughter", "kid", "kids"];
var job3 = ["Job", 4, false, "job", "jobs", "work"];
var game7 = ["We surveyed 100 single women. Tell me something you have that lasted longer than most relationships.", shoes3, jewl, house3, car3, pet3, friends2, child3, job3];
// then each gameboard is arranged into an array, making the 3D array of games
var games = [game1, game5, game2, game3, game4, game6, game7, game9, game10];
var gameNum = 0;
var wrongAnswers = 0;
